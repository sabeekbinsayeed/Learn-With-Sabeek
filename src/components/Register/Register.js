...
const Register = () => {
    ...
    return (
        <div style={{ minHeight: '100vh' }} >
            <h2 style={{ textAlign: 'center', marginBottom: '60px', color: 'orangeRed', marginTop: '20px' }}>Please Register</h2>
            ...
            <div className='d-flex ps-5 ms-3'>
                ...
                <div className=' half register-form me-5 pe-5' style={{ marginTop: '70px' }}>
                    <form onSubmit={handleRegister}>
                        ...
                        <Button disabled={!agree} variant="primary w-50 mx-auto d-block mb-2 mt-4 bg-warning" type="submit">
                            Register
                        </Button>
                    </form>
